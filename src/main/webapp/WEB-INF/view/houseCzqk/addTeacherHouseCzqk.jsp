...
<body onload="displayTeacher()">
<div id="wrapper">
    <!--引入公共页面-->
    <jsp:include page="../teacherCommon.jsp"/>
    <div id="page-wrapper">
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="col-lg-4 ">
                    <form onsubmit="false" role="form" id="addForm" class="form-horizontal"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input type="text" id="zzjsszbm" name="zzjsszbm" class="form-control" value="" size="30">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-6 control-label">租住教师编号:<span class="must">*</span></label>
                            <div class="col-sm-6">
                                <input type="text" id="zzjsbh" name="zzjsbh" class="form-control" value="" size="6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input type="text" id="zzjsxm" name="zzjsxm" class="form-control" value="" size="10">
                            </div>
                        </div>
                        <div class="form-group">
...
<script type="text/javascript">
    ...
    function  displayTeacher() {
        $.ajax({
            type: "post",
            dataType: "json",
            url: "/houseCzqk/selectTeacherBySession",
            data: {"jggh": ${sessionScope.admins.user}},
            success: function (data) {
                var object = $.parseJSON(data);
                $("input[id=zzjsszbm]").val(object.szbm);
                $("input[id=zzjsbh]").val(object.jggh);
                $("input[id=zzjsxm]").val(object.xm);
            }
        });
    }
</script>
