...
public class HouseCzqkServiceImpl extends ServiceImpl<HouseCzqkMapper, HouseCzqk> implements HouseCzqkService {
     ...
     */
    @Override
    public ModelAndView selectHousePubToCzqkById(ModelAndView modelAndView, int id) {
        ...
        if (!ObjectUtils.isEmpty(housePub)) {
            ...
            modelAndView.setViewName("houseCzqk/addHousePubCzqk");
        } else {
    ...
    @Override
    public String addHousePubCzqk(HouseCzqk houseCzqk) {
